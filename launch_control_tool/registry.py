...
"""
Module with RegistryMeta and RegistryBase classes for dynamically
finding sub-classes at runtime.
"""
...
class RegistryBase(object):
    ...
    def get_direct_subclasses(cls):
        ...
        [<class 'launch_control_tool.registry.B'>]
        """
    ...
    def get_subclasses(cls):
        ...
        >>> class C(B): pass
        >>> A.get_subclasses()
        [<class 'launch_control_tool.registry.B'>, <class 'launch_control_tool.registry.C'>]
        """
